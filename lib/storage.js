 ...
 */
Piece.prototype.read = function (range, cb) {
  var self = this
  ...
  if (!self.verified) {
    return cb(new Error('Piece.read called on incomplete piece ' + self.index))
  }
  ...
  function readNextBlock () {
    ...
    self.readBlock(blockOffset, blockLength, function (err, block) {
...
File.prototype.select = function () {
  var self = this
  // TODO: handle case where file length is 0
