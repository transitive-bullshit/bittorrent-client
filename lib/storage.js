...
Piece.prototype._verify = function () {
  ...
  console.error("VERIFY: " + self.hash)
...
Storage.prototype._onPieceDone = function (piece) {
  var self = this
  console.log('PIECE DONE', piece.index, self.progress, self.numMissing)
...
Storage.prototype._onFileDone = function (file) {
  var self = this
  console.log('FILE DONE', file.name, self.progress, self.numMissing)
  self.emit('file', file)
